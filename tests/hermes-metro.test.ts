/**
 * [INPUT]: 依赖固定 SHA256 的 Metro bundle fixture、Hermes 编译器与语义审计器
 * [OUTPUT]: 验证真实大体积 Metro HBC 的零长度函数与 base/plain 等价性
 * [POS]: CLI Hermes 集成回归，仅在显式提供 fixture 目录时运行，不产生网络副作用
